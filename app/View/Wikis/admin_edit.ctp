...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">
            Edit <i><?php echo $this->request->data['Wiki']['title']; ?></i>
    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <?php echo $this->Form->submit('Submit changes', array('div' => false, 'class' => 'btn btn-primary')); ?>
                        <?php echo $this->Html->link('Reset page', '/' . $this->request->url, array('class' => 'btn btn-default pull-right')); ?>
                    </div>
                </div>
